...
declare module 'electron-builder' {
  ...
  export { AppMetadata, DevMetadata, Platform, Arch, archFromString, BuildMetadata, OsXBuildOptions, WinBuildOptions, LinuxBuildOptions, CompressionLevel } from "electron-builder/out/metadata"
}
...
declare module 'electron-builder/out/log' {
  import { Promise as BluebirdPromise } from "bluebird"
...
declare module 'electron-builder/out/targets/nsis' {
  ...
  export default class NsisTarget {
    constructor(packager: WinPackager, outDir: string, appOutDir: string)
    build(arch: Arch): Promise<void>
  }
}
...
declare module 'electron-builder/out/targets/squirrelWindows' {
  ...
  export default class SquirrelWindowsTarget {
    constructor(packager: WinPackager, appOutDir: string)
    build(arch: Arch): Promise<void>
    computeEffectiveDistOptions(installerOutDir: string, setupExeName: string): Promise<WinBuildOptions>
  }
}
